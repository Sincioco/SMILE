...
internal static class Program
{
    ...
    private static void PrintUsage()
    {
        ...
        Console.Error.WriteLine("  Unicode text inspection, Load Text File, integer/Data Load/Save, nominal enums and Type value records, Double math/conversions, ByRef, Optional defaults, named arguments, and multiline routine declarations are supported.");
    }
}
