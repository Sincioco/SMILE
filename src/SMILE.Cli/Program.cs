...
internal static class Program
{
    ...
    private static void PrintUsage()
    {
        ...
        Console.Error.WriteLine("  Unicode text inspection, Load Text File, Double math/conversions, Optional defaults, named arguments, and multiline routine declarations are supported.");
    }
}
