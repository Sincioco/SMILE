...
internal static class Program
{
    ...
    private static void PrintUsage()
    {
        ...
        Console.Error.WriteLine("  Unicode text inspection, Load Text File, integer Load/Save, Double math/conversions, ByRef, Optional defaults, named arguments, and multiline routine declarations are supported.");
    }
}
