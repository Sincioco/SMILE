...
public sealed class MainWindowViewModel : ViewModelBase
{
    ...
    private void ShowAbout()
    {
        ...
        string version =
            ...
            "unknown";
        const string mission = "SMILE is a beginner-first language inspired by BASIC. Students write one clear program, then compare the readable code generated for ten destination languages. SMILE Core BASIC 2.1 adds a small text-game foundation—fixed two-dimensional arrays, nonblocking keys, screen redraw, timing, and randomness—without adding graphics or hiding the lesson behind a framework. Unicode text inspection, Double math and explicit conversions, Optional defaults, named arguments, and multiline routine declarations extend that core. The goal is not to memorize one syntax, but to build logical thinking and recognize the shared fundamentals underneath many languages.";
